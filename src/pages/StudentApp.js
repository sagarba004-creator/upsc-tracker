          ...
          {loading ? (
            ...
            <div style={{ display:'flex', flexWrap:'wrap', gap:6, padding:'2px 0' }}>
              {filtered
                ...
                .map((t, i) => {
                  const yr = t.pyq_years ? String(t.pyq_years).match(/\d{4}/) : null;
                  const year = yr ? yr[0] : '?';
                  ...
                  return (
                    <div key={i} style={{
                      ...
                      maxWidth:'48%', minWidth:80,
                    }}>
                      <span style={{ color:'#2E7D32', fontSize:10, fontWeight:800, lineHeight:1.2 }}>{year}</span>
                      {kw ? <span style={{ color:'#1B5E20', fontSize:9, fontWeight:500, lineHeight:1.3, whiteSpace:'normal' }}>{kw}</span> : null}
                    </div>
                  );
                })
              }
